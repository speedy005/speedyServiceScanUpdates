...
class SSUUpdateScreen(Screen, ConfigListScreen):
    def __init__(self, session):
        ...
        print "Screen width: %d, Screen height: %d" % (w, h)

        # Bestimmen der Bildschirmbreite basierend auf der Auflösung
        sz_w = 1180 if w >= 1920 and h >= 1080 else 1050
        print "sz_w is set to: %d" % sz_w

        # Skin für verschiedene Auflösungen festlegen
        if w >= 1920 and h >= 1080:
            self.skin_update = """
            <screen name="SSUUpdateScreen" position="center,170" size="1200,820" title="speedy Service Scan Updates" backgroundColor="black">
        ...
        self.download_progress = 0  # Initialize progress
    ...
    def _update_gui(self):
        ...
        self['progresstext'].setText("%d%%" % self.download_progress)
        ...
        try:
            ...
            for item in os.listdir(update_folder):
                ...
                try:
                    ...
                    print "Fehler beim Kopieren: %s" % str(e)
                    pass
            ...
            print "Fehler in _finish_update: %s" % str(e)
    ...
    def _requests_missing(self):
        try:
            ...
            self['status'].setText(_("Requests library not found. Please install it."))
            return True
    ...
    def check_update(self):
        ...
        try:
            ...
            print "Fehler beim Überprüfen des Updates: %s" % str(e)
    ...
    def start_update(self):
        ...
        try:
            ...
            print "Fehler beim Download des Updates: %s" % str(e)
            self['status'].setText(_("Download failed"))
    ...
    def _screen_size(self):
        # Bildschirmauflösung korrekt abfragen
