    ...
    def __init__(self, session):
        ...
        if width >= 1920:
            self.skin = """<screen name="SSUUpdateScreen" position="center,170" size="1200,820" title="speedy Service Scan Updates" backgroundColor="black">
                <widget name="progress" position="10,100" size="1180,50" foregroundColor="red" backgroundColor="black" />
                <widget name="status" position="12,160" size="1180,50" font="Regular;30" valign="center" halign="center" backgroundColor="black" foregroundColor="green" />
                <widget name="progresstext" position="10,220" size="1180,50" font="Regular;30" valign="center" halign="center" backgroundColor="black" foregroundColor="blue" />
                <widget name="key_red" position="3,4" size="295,70" font="Regular;30" halign="center" valign="center" foregroundColor="red" backgroundColor="black" />
                <widget name="key_green" foregroundColor="green" position="305,3" size="300,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
                <widget name="key_yellow" foregroundColor="yellow" position="609,3" size="300,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
                <widget name="key_blue" foregroundColor="blue" position="917,4" size="295,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
            ...
            self.skin = """<screen name="SSUUpdateScreen" position="410,170" size="1100,820" title="speedy Service Scan Updates" backgroundColor="black">
                <widget name="progress" position="10,100" size="1050,50" foregroundColor="red" backgroundColor="black" />
                <widget name="status" position="10,160" size="1050,50" font="Regular;30" backgroundColor="black" valign="center" halign="center" foregroundColor="green" />
                ...
                <widget name="key_red" position="13,2" size="250,70" font="Regular;30" halign="center" valign="center" foregroundColor="red" backgroundColor="black" />
                <widget name="key_green" foregroundColor="green" position="277,3" size="250,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
                <widget name="key_yellow" foregroundColor="yellow" position="538,4" size="250,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
                <widget name="key_blue" position="798,5" foregroundColor="blue" size="250,70" font="Regular;30" halign="center" valign="center" backgroundColor="black" />
