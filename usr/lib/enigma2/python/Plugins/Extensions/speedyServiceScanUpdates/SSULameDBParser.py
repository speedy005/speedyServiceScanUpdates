...
class SSULameDBParser:
    ...
    def load(self):
        try:
            print("[speedyServiceScanUpdates] Reading file: " + self.filename)
            import codecs
            ...
            if lines and "/3/" in lines[0]:
                ...
                print("[speedyServiceScanUpdates] Unsupported lamedb version")
                lines = None
            return lines
        except Exception as e:
            print("[speedyServiceScanUpdates] Exception reading lamedb: " + str(e))
            return None
    ...
    def parse(self, lines):
        ...
        print("[speedyServiceScanUpdates] Parsing content of file: " + self.filename)
        for line in lines:
            line = line.rstrip('\n')
            if PY2:
