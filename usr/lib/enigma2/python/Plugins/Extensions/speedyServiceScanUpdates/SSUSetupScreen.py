...
if sz_w == 1920 and sz_h == 1080:
    skin_update = """<screen name="SSUUpdateScreen" position="center,170" size="1200,820" title="speedy Service Scan Updates">
        ...
        <widget name="version" position="488,769" size="200,30" font="Regular;30" valign="center" halign="center" />  <!-- Version hinzugefügt -->
    </screen>"""
    ...
    skin_setup = """<screen name="SSUSetupScreen" position="center,170" size="1200,820" title="speedy Service Scan Updates">
        ...
        <widget name="version" position="955,23" size="200,30" font="Regular;30" valign="center" halign="center" />  <!-- Version hinzugefügt -->
    </screen>"""
else:
    skin_update = """<screen name="SSUUpdateScreen" position="410,170" size="1100,820" title="speedy Service Scan Updates">
        ...
        <widget name="version" position="364,784" size="300,20" font="Regular;30" valign="center" halign="center" />  <!-- Version hinzugefügt -->
    </screen>"""
    
    skin_setup = """<screen name="SSUSetupScreen" position="510,170" size="900,820" title="speedy Service Scan Updates">
        ...
        <widget name="help" position="-3,652" size="850,145" font="Regular;32" />
        <widget name="version" position="268,764" size="300,30" font="Regular;30" valign="center" halign="center" zPosition="5" />  <!-- Version hinzugefügt -->
    </screen>"""
